...
namespace SCP5000
{
    public class Config : IConfig
    {
        ...
        [Description("Enable/Disable the Player Effect.")]
        ...
        [Description("Broadcast when SCP-5000 go near a Tesla Gate. Only available when <TeslaTriggerable> has been set to <false>")]
        ...
        [Description("Set the Broadcast when SCP-5000 attempt to enter the Femur Breaker. Only available when <FemurBreakerTriggerable> has been set to <false>")]
        ...
        [Description("Set the Broadcast when SCP-5000 protect you from become a target of SCP-096. Only available when <AddingTarget> has been set to <false>.")]
